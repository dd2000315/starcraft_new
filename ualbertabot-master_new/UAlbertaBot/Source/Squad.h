...
#include "ScienceVesselManager.h"//自己加的
#include "TerranDropManager.h"//自己加的
...
class Squad
{
    ...
    TerranDropManager   m_terranDropManager;//自己加的
    ScienceVesselManager m_scienceVesselManager;//自己加的
    ComsatStationManager m_comsatStationManager;
    WraithManager        m_wraithManager;
